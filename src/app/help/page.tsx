  ...
  return (
    <div className={pageClasses.wrapper}>
      <div className={pageClasses.container}>
        <h1 className={pageClasses.title}>Help & Support</h1>

        <div className="space-y-8">
          <div className={cardClasses.wrapper}>
            <div className={cardClasses.content}>
              <h2 className={cardClasses.header}>Frequently Asked Questions</h2>
          ...
          <div className={cardClasses.wrapper}>
            <div className={cardClasses.content}>
              <h2 className={cardClasses.header}>Contact Information</h2>
          ...
          <div className={cardClasses.wrapper}>
            <div className={cardClasses.content}>
              <h2 className={cardClasses.header}>Order Issues</h2>
