...
export default function CateringPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f0e3] py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-[#db4f43] mb-4">Catering Services</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h2 className="text-2xl font-bold text-[#db4f43] mb-4">Catering Information</h2>
