// Simple script to seed the database with initial sandwich data
// Run this in the Convex dashboard or via the API
...
console.log("Seed data ready to be inserted:");
console.log(JSON.stringify(sandwiches, null, 2));
console.log("\nTo seed the database:");
console.log("1. Go to your Convex dashboard");
console.log("2. Navigate to the Functions tab");
console.log("3. Run the 'seedSandwiches' function");
console.log("4. Or use the Convex CLI: npx convex run seed:seedSandwiches");